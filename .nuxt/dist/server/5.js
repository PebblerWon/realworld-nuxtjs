...
/* harmony default export */ var loginvue_type_script_lang_js_ = ({
  ...
  methods: {
    async onSubmit() {
      ...
      try {
        const data = await utils_request({
          method: 'POST',
          url: '/api/users/login',
          data: this.user
        });
